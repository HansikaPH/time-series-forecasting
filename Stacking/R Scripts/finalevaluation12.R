cif_df=read.csv(file="/home/hhew0002/Academic/Monash University/Research Project/Codes/time-series-forecasting/DataSets/CIF 2016/cif-results.txt",sep=';',header = FALSE)

text_df_12=read.csv(file="/home/hhew0002/Academic/Monash University/Research Project/Codes/time-series-forecasting/DataSets/CIF 2016/cif12test.txt",sep = " ",header = FALSE)
...
# print(unique(value))
# print(rev(value))
# print(match(unique(value), rev(value)))
# print(length(value))
...
forecast_df_12=read.csv("/home/hhew0002/Academic/Monash University/Research Project/Codes/time-series-forecasting/DataSets/CIF 2016/forecasts.txt", header = F, sep = ",")
