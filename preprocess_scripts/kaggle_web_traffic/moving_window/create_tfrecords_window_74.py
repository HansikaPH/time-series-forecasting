...
if __name__ == '__main__':
    tfrecord_writer = TFRecordWriter(
        ...
        binary_train_file_path = '../../../datasets/binary_data/kaggle_web_traffic/moving_window/kaggle_stl_59i74.tfrecords',
        binary_validation_file_path = '../../../datasets/binary_data/kaggle_web_traffic/moving_window/kaggle_stl_59i74v.tfrecords',
        binary_test_file_path = '../../../datasets/binary_data/kaggle_web_traffic/moving_window/kaggle_test_59i74.tfrecords'
    )
