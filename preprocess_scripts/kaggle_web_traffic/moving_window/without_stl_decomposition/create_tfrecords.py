...
if __name__ == '__main__':
    tfrecord_writer = TFRecordWriter(
        ...
        binary_train_file_path = '../../../../datasets/binary_data/kaggle_web_traffic/moving_window/without_stl_decomposition/kaggle_59i9.tfrecords',
        binary_validation_file_path = '../../../../datasets/binary_data/kaggle_web_traffic/moving_window/without_stl_decomposition/kaggle_59i9v.tfrecords',
        binary_test_file_path = '../../../../datasets/binary_data/kaggle_web_traffic/moving_window/without_stl_decomposition/kaggle_test_59i9.tfrecords'
    )
