...
train_file = "../../datasets/text_data/Electricity/original_electricity_data_validation.csv"
results_file = "../../datasets/text_data/Electricity/electricity_results_validation.csv"
