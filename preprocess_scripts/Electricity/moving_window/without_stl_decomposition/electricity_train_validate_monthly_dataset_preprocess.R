library(forecast)
OUTPUT_DIR = "/media/hhew0002/f0df6edb-45fe-4416-8076-34757a0abceb/hhew0002/Academic/Monash University/Research Project/Codes/time-series-forecasting/datasets/text_data/Electricity/moving_window/without_stl_decomposition/"
...
for (validation in c(TRUE, FALSE)) {#
    ...
    for (idr in 1 : length(electricity_dataset)) {
        ...
        OUTPUT_PATH = paste(OUTPUT_DIR, "electricity_", sep = '/')
