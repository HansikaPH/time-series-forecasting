...
if __name__ == '__main__':
    tfrecord_writer = TFRecordWriter(
        ...
        binary_train_file_path = '../../../datasets/binary_data/NN3/moving_window/nn3_stl_18i13.tfrecords',
        binary_validation_file_path = '../../../datasets/binary_data/NN3/moving_window/nn3_stl_18i13v.tfrecords',
        binary_test_file_path = '../../../datasets/binary_data/NN3/moving_window/nn3_test_18i13.tfrecords',
    )
