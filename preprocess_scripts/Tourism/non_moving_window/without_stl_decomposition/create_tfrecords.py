...
if __name__ == '__main__':
    tfrecord_writer = TFRecordWriter(
        ...
        binary_train_file_path='../../../../datasets/binary_data/Tourism/non_moving_window/without_stl_decomposition/tourism_24.tfrecords',
        binary_validation_file_path='../../../../datasets/binary_data/Tourism/non_moving_window/without_stl_decomposition/tourism_24v.tfrecords',
        binary_test_file_path='../../../../datasets/binary_data/Tourism/non_moving_window/without_stl_decomposition/tourism_test_24.tfrecords',
