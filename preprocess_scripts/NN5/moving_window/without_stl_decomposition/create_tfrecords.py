...
if __name__ == '__main__':
    tfrecord_writer = TFRecordWriter(
        ...
        binary_train_file_path = '../../../../datasets/binary_data/NN5/moving_window/without_stl_decomposition/nn5_56i9.tfrecords',
        binary_validation_file_path = '../../../../datasets/binary_data/NN5/moving_window/without_stl_decomposition/nn5_56i9v.tfrecords',
