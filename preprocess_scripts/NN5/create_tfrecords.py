...
if __name__ == '__main__':
    tfrecord_writer = TFRecordWriter(
        ...
        binary_train_file_path = '../../datasets/binary_data/NN5/nn5_stl_56i70.tfrecords',
        binary_validation_file_path = '../../datasets/binary_data/NN5/nn5_stl_56i70v.tfrecords',
        binary_test_file_path = '../../datasets/binary_data/NN5/nn5_test_56i70.tfrecords',
    )
