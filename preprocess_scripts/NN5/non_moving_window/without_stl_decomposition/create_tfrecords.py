...
if __name__ == '__main__':
    tfrecord_writer = TFRecordWriter(
        output_size = 56,
        train_file_path = '../../../../datasets/text_data/NN5/non_moving_window/without_stl_decomposition/nn5_stl_56.txt',
        validate_file_path = '../../../../datasets/text_data/NN5/non_moving_window/without_stl_decomposition/nn5_stl_56v.txt',
        test_file_path = '../../../../datasets/text_data/NN5/non_moving_window/without_stl_decomposition/nn5_test_56.txt',
        binary_train_file_path = '../../../../datasets/binary_data/NN5/non_moving_window/without_stl_decomposition/nn5_stl_56.tfrecords',
        binary_validation_file_path = '../../../../datasets/binary_data/NN5/non_moving_window/without_stl_decomposition/nn5_stl_56v.tfrecords',
