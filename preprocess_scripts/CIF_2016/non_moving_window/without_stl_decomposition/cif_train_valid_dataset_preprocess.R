...
OUTPUT_DIR="/media/hhew0002/f0df6edb-45fe-4416-8076-34757a0abceb/hhew0002/Academic/Monash University/Research Project/Codes/time-series-forecasting/datasets/text_data/CIF_2016/non_moving_window/without_stl_decomposition/"
...
for (validation in c(TRUE,FALSE)) {# 
	...
	for (idr in 1: nrow(cif_df)) {
	  ...
	  series=as.character(oneLine_df$Series) 
		...
		level=ylog[n-maxForecastHorizon]
		normalized_values = ylog-level
