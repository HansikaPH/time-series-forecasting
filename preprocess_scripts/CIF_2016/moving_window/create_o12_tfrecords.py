...
if __name__ == '__main__':
    tfrecord_writer = TFRecordWriter(
        ...
        binary_train_file_path = output_path + 'stl_12i15_v2.tfrecords',
        binary_validation_file_path = output_path + 'stl_12i15v_v2.tfrecords',
        binary_test_file_path = output_path + 'cif12test_v2.tfrecords'
    )
