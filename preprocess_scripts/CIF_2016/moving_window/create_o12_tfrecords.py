...
if __name__ == '__main__':
    tfrecord_writer = TFRecordWriter(
        ...
        binary_train_file_path = '../../../datasets/binary_data/CIF_2016/moving_window/stl_12i15.tfrecords',
        binary_validation_file_path = '../../../datasets/binary_data/CIF_2016/moving_window/stl_12i15v.tfrecords',
        binary_test_file_path = '../../../datasets/binary_data/CIF_2016/moving_window/cif12test.tfrecords'
    )
