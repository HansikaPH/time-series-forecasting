...
for (idr in 1 : nrow(cif_df_12)) {
    ...
    for (inn in inputSize : (n)) {
        ...
        for (ii in 1 : inputSize) {
            sav_df[, paste('r', ii, sep = '')] = ylog[inn - inputSize + ii]  #inputs: past values normalized by the level
        }
...
write.table(
save12_df,
file = "/media/hhew0002/f0df6edb-45fe-4416-8076-34757a0abceb/hhew0002/Academic/Monash University/Research Project/Codes/time-series-forecasting/datasets/text_data/CIF_2016/moving_window/without_stl_decomposition/cif12test.txt",
row.names = F,
col.names = F,
sep = " ",
quote = F
...
write.table(
save6_df,
file = "/media/hhew0002/f0df6edb-45fe-4416-8076-34757a0abceb/hhew0002/Academic/Monash University/Research Project/Codes/time-series-forecasting/datasets/text_data/CIF_2016/moving_window/without_stl_decomposition/cif6test.txt",
row.names = F,
col.names = F,
sep = " ",
quote = F
