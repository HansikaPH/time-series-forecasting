...
train_file_path = 'datasets/CIF_2016/stl_12i15.txt'
validate_file_path = 'datasets/CIF_2016/stl_12i15v.txt'
test_file_path = 'datasets/CIF_2016/cif12test.txt'
...
def write_to_tfrecord_file(tfrecord_file_path, list_of_inputs, list_of_metadata, list_of_outputs):
    ...
    writer = tf.python_io.TFRecordWriter(tfrecord_file_path, tf.python_io.TFRecordOptions(tf.python_io.TFRecordCompressionType.ZLIB))
