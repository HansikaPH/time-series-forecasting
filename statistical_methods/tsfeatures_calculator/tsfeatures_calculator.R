...
input_file = "/media/hhew0002/f0df6edb-45fe-4416-8076-34757a0abceb/hhew0002/Academic/Monash University/Research Project/Codes/time-series-forecasting/datasets/text_data/CIF_2016/all_cif_data.txt"
frequency = 12
...
for(i in 1:length(dataset)){
    ...
    seasonal_strength= tryCatch({
        tsfeatures(ts(time_series, freq=as.numeric(frequency)), parallel=TRUE)
