cif_df=read.csv(file="./DataSets/CIF 2016/cif-results.txt",sep=';',header = FALSE)

text_df_12=read.csv(file="../../DataSets/CIF 2016/cif12test.txt",sep = " ",header = FALSE)
...
forecast_df_12=read.csv("../../DataSets/CIF 2016/forecasts.txt", header = F, sep = ",")
