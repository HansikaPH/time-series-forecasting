...
file = read.csv(file="./datasets/text_data/kaggle_web_traffic/kaggle_seasonality.txt", sep=",", header = FALSE)
...
png("./graph_plotter/kaggle_seasonality_pattern.png", width = 2000, height = 1000)
ggplot(data=dataset,
