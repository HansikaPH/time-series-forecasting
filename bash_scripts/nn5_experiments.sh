...
python ./generic_model_trainer.py --dataset_name nn5 --contain_zero_values 1 --binary_train_file datasets/binary_data/NN5/nn5_stl_56i70.tfrecords --binary_valid_file datasets/binary_data/NN5/nn5_stl_56i70v.tfrecords --binary_test_file datasets/binary_data/NN5/nn5_test_56i70.tfrecords --txt_test_file datasets/text_data/NN5/moving_window/nn5_test_56i70.txt --actual_results_file datasets/text_data/NN5/nn5_results.txt --input_size 70 --forecast_horizon 56 --optimizer adagrad --hyperparameter_tuning smac --model_type stacking
