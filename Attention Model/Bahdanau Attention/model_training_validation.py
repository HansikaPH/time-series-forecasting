...
def train_model(configs):
    ...
    print("LSTM Cell Dimension: {}, mbSize: {}, maxEpochSize: {}, maxNumOfEpochs: {}, "
          ...
          format(num_units, minibatch_size, max_epoch_size, max_num_of_epochs,
    ...
    decoder_cell = tf.contrib.seq2seq.AttentionWrapper(cell = decoder_cell, attention_mechanism = attention_mechanism, attention_layer_size = num_units)
...
if __name__ == '__main__':
    ...
    lstm_cell_dimension = UniformIntegerHyperparameter("num_units", 20, 50, default_value = 50)
